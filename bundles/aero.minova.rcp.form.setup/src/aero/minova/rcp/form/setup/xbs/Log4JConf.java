...
@XmlRootElement(name = "log4j-conf")
public class Log4JConf {

    @XmlElement(required = true)
    protected List<Log4JConf.Entry> entry;
     ...
     * {@link Log4JConf.Entry }
     * 
     * 
     */
    public List<Log4JConf.Entry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<Log4JConf.Entry>();
        }
        return this.entry;
    }
