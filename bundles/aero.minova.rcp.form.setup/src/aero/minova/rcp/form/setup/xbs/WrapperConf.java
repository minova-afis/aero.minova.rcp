...
@XmlRootElement(name = "wrapper-conf")
public class WrapperConf {

    @XmlElement(required = true)
    protected List<WrapperConf.Entry> entry;
     ...
     * {@link WrapperConf.Entry }
     * 
     * 
     */
    public List<WrapperConf.Entry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<WrapperConf.Entry>();
        }
        return this.entry;
    }
