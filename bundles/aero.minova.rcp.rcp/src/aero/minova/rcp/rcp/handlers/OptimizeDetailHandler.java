...
public class OptimizeDetailHandler {
	...
	@Execute
	public void execute(EModelService emservice, MWindow mwindow, MPerspective perspective) {
		MPartSashContainer element = (MPartSashContainer) emservice.find("aero.minova.rcp.rcp.partsashcontainer.main", mwindow);
		element.getChildren();
