	...
	public IContentProposal[] getProposals(String contents, int position) {
		if (table != null) {
			...
			for (Row row : table.getRows()) {
				...
				proposals.add(new MinovaContentProposal(row.getValue(table.getColumnIndex("KeyLong")).getIntegerValue(),
						row.getValue(table.getColumnIndex("KeyText")).getStringValue(), descr));
			}
		}
