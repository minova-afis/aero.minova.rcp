 ...
 * @since 3.2
 */
public class MinovaCustomContentProposalAdapter {
...
//					return;
	 ...
	 */
	private ListenerList<IMinovaCustomContentProposalListener2> proposalListeners2 = new ListenerList<>();
	 ...
	 */
	public void addContentProposalListener(IMinovaCustomContentProposalListener2 listener) {
		...
		if (isValid()) {
			if (popup == null) {
				...
				if (proposals.length > 0) {
					...
					popup.open();
					System.out.println("Ausführende Klasse:" + this + "Autoactivation:" + autoActivated);
	...
	private void autoActivate() {
		...
		// Issue #205 : Eine automatische Öffnung des Feldes ist nicht vorgesehen.
...
//		}
	...
	private void notifyPopupOpened() {
		...
		for (IMinovaCustomContentProposalListener2 l : proposalListeners2) {
