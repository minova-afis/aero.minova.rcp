...
Zeiteinträge werden stehts mit einem Datum von 01.01.1900 versehen. Auserdem werden sie auf ihre Minuten gerundet.


Wir haben für die Datumsfelder ebenfalls bestimmte Shortcuts definiert.
