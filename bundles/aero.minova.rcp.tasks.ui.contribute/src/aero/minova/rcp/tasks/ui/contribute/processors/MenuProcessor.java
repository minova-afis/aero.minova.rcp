package aero.minova.rcp.tasks.ui.contribute.processors;
...
import aero.minova.rcp.tasks.ui.contribute.handlers.ExitHandlerWithCheck;
	...
	public void execute(EModelService modelService) {
		...
		if (menu != null) {
			...
			menuItem.setContributionURI(
					"bundleclass://" + "com.vogella.tasks.ui.contribute/" + ExitHandlerWithCheck.class.getName());
