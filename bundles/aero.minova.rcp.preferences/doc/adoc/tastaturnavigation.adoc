...
=== Key-Bindings Part spezifisch machen

Folgendes muss beachtet werden, um Key-Bindings einem oder mehreren bestimmten Parts zuzuweisen:

*Ein Part*

- Der Handler soll in der Liste der Handler im jeweiligen Part sein.
- Der Handler muss eine CanExecute Methode enthalten, die true zurückliefert, wenn man sich im gewünschten Part befindet.

*Mehrere Parts*

- Der Handler muss eine CanExecute Methode enthalten, die true zurückliefert, wenn man sich in einem der gewünschten Parts befindet.
