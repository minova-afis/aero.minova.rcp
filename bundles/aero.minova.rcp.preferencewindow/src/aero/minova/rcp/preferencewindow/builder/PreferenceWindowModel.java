...
public class PreferenceWindowModel {
	...
	private PreferenceTabDescriptor buildAnwendungsTab(TranslationService translationService) {
		...
		psd.add(new PreferenceDescriptor(ApplicationPreferences.LICENCE_WARNING_BEFORE_WEEKS,
				translationService.translate("@Preferences.LicenceWarningBeforeWeeks", null),
				translationService.translate("@Preferences.LicenceWarningBeforeWeeks.Tooltip", null), 0.1, DisplayType.INTEGER, 0));
		...
		psd.add(new PreferenceDescriptor("CurrentWorkspace", translationService.translate("@Preferences.CurrentWorkspace", null),
				translationService.translate("@Preferences.CurrentWorkspace.Tooltip", null), 0.3, DisplayType.CUSTOMCHECK, false));
		psd.add(new PreferenceDescriptor("SendLogs", translationService.translate("@Preferences.SendLogs", null),
				translationService.translate("@Preferences.SendLogs.Tooltip", null), 0.4, DisplayType.SENDLOGSBUTTON, false));
		...
		psd.add(new PreferenceDescriptor(ApplicationPreferences.ENTER_SELECTS_FIRST_REQUIRED,
				translationService.translate("@Preferences.EnterSelectFirstRequired", null),
				translationService.translate("@Preferences.EnterSelectFirstRequired.Tooltip", null), 0.1, DisplayType.CHECK, true));
		...
		psd.add(new PreferenceDescriptor(ApplicationPreferences.SELECT_ALL_CONTROLS, translationService.translate("@Preferences.SelectAllControls", null),
				translationService.translate("@Preferences.SelectAllControls.Tooltip", null), 0.4, DisplayType.CHECK, true));
		return ptd;
	}
	...
	private PreferenceTabDescriptor buildDarstellungsTab(TranslationService translationService) {
		...
		ptd.add(psd);
		psd.add(new PreferenceDescriptor(ApplicationPreferences.LOCALE_LANGUAGE, translationService.translate("@Preferences.LocalLanguage", null),
				translationService.translate("@Preferences.LocalLanguage.Tooltip", null), 0.2, DisplayType.LOCALE,
				Locale.getDefault().getDisplayLanguage(Locale.getDefault())));
		psd.add(new PreferenceDescriptor(ApplicationPreferences.TIMEZONE, translationService.translate("@Preferences.Timezone", null),
				translationService.translate("@Preferences.Timezone.Tooltip", null), 0.3, DisplayType.ZONEID,
		...
		ptd.add(psd);
		psd.add(new PreferenceDescriptor(ApplicationPreferences.FONT_ICON_SIZE, translationService.translate("@Preferences.FontSize", null),
				translationService.translate("@Preferences.FontSize.Tooltip", null), 0.1, DisplayType.COMBO, "M", "S", "M", "L", "XL"));
		psd = new PreferenceSectionDescriptor("Fromatting", translationService.translate("@Preferences.Formatting", null), 0.3);
		ptd.add(psd);
		psd.add(new PreferenceDescriptor(ApplicationPreferences.DATE_UTIL, translationService.translate("@Preferences.DateUtilPattern", null),
				translationService.translate("@Preferences.DateUtilPattern.Tooltip", null), 0.1, DisplayType.DATE_UTIL, ""));
		psd.add(new PreferenceDescriptor(ApplicationPreferences.TIME_UTIL, translationService.translate("@Preferences.TimeUtilPattern", null),
				translationService.translate("@Preferences.TimeUtilPattern.Tooltip", null), 0.2, DisplayType.TIME_UTIL, ""));
		...
		psd.add(new PreferenceDescriptor(ApplicationPreferences.SHOW_HIDDEN_SECTIONS, //
				translationService.translate("@Preferences.ShowHiddenSections", null),
				translationService.translate("@Preferences.ShowHiddenSections.Tooltip", null), 0.1, DisplayType.CHECK, false));
	...
	private PreferenceTabDescriptor buildErweiterungTab(TranslationService translationService) {
		...
		ptd.add(psd);
		psd.add(new PreferenceDescriptor(ApplicationPreferences.AUTO_LOAD_INDEX, translationService.translate("@Preferences.AutoLoadIndex", null),
				translationService.translate("@Preferences.AutoLoadIndex.Tooltip", null), 0.1, DisplayType.CHECK, false));
		...
		psd.add(new PreferenceDescriptor(ApplicationPreferences.SHEET_STYLES_MESSAGE_BOXES,
				translationService.translate("@Preferences.SheetStylesMessageBoxes", null),
				translationService.translate("@Preferences.SheetStylesMessageBoxes.Tooltip", null), 0.3, DisplayType.CHECK, true));
		psd.add(new PreferenceDescriptor(ApplicationPreferences.SHOW_DETAIL_BUTTON_TEXT,
				translationService.translate("@Preferences.ShowDetailButtonText", null),
				translationService.translate("@Preferences.ShowDetailButtonText.Tooltip", null), 0.4, DisplayType.CHECK, true));
		psd.add(new PreferenceDescriptor(ApplicationPreferences.USE_FORM_BUFFER, translationService.translate("@Preferences.UseFormBuffer", null),
				translationService.translate("@Preferences.UseFormBuffer.Tooltip", null), 0.5, DisplayType.CHECK, true));
		...
		psd.add(new PreferenceDescriptor(ApplicationPreferences.SHOW_DELETE_WARNING, translationService.translate("@Preferences.ShowDeleteWarning", null),
				translationService.translate("@Preferences.ShowDeleteWarning.Tooltip", null), 0.8, DisplayType.CHECK, xbsShowDelete));
		...
		psd.add(new PreferenceDescriptor(ApplicationPreferences.DISPLAY_BUFFER_MS, translationService.translate("@Preferences.Buffer.DisplayBufferMs", null),
				translationService.translate("@Preferences.Buffer.DisplayBufferMs.Tooltip", null), 0.1, DisplayType.INTEGER, 20));
		psd.add(new PreferenceDescriptor(ApplicationPreferences.MAX_BUFFER_MS, translationService.translate("@Preferences.Buffer.MaxBufferMs", null),
				translationService.translate("@Preferences.Buffer.MaxBufferMs.Tooltip", null), 0.2, DisplayType.INTEGER, 90));
		...
		psd.add(new PreferenceDescriptor(ApplicationPreferences.TIMEOUT_OPEN_NOTIFICATION,
				translationService.translate("@Preferences.Timeout.TimeoutOpenNotification", null),
				translationService.translate("@Preferences.Timeout.TimeoutOpenNotification.Tooltip", null), 0.2, DisplayType.INTEGER, 1));
...
//				0.5, DisplayType.CHECK, true));
	...
	private PreferenceTabDescriptor buildDruckenTab(TranslationService translationService) {
		...
		ptd.add(psd);
		psd.add(new PreferenceDescriptor(ApplicationPreferences.CREATE_XML_XS, translationService.translate("@Preferences.Print.CreateXMLXSL", null),
				translationService.translate("@Preferences.Print.CreateXMLXSL.Tooltip", null), 0.1, DisplayType.CHECK, false));
		psd.add(new PreferenceDescriptor(ApplicationPreferences.INDEX_FONT, translationService.translate("@Preferences.Print.IndexFont", null),
				translationService.translate("@Preferences.Print.IndexFont.Tooltip", null), 0.2, DisplayType.FONT, null));
		psd.add(new PreferenceDescriptor(ApplicationPreferences.OPTIMIZED_WIDTHS, translationService.translate("@Preferences.Print.OptimizeWidths", null),
				translationService.translate("@Preferences.Print.OptimizeWidths.Tooltip", null), 0.3, DisplayType.CHECK, true));
		psd.add(new PreferenceDescriptor(ApplicationPreferences.HIDE_EMPTY_COLS, translationService.translate("@Preferences.Print.HideEmptyCols", null),
				translationService.translate("@Preferences.Print.HideEmptyCols.Tooltip", null), 0.4, DisplayType.CHECK, true));
		psd.add(new PreferenceDescriptor(ApplicationPreferences.HIDE_GROUP_COLS, translationService.translate("@Preferences.Print.HideGroupCols", null),
				translationService.translate("@Preferences.Print.HideGroupColsTooltip", null), 0.5, DisplayType.CHECK, true));
		psd.add(new PreferenceDescriptor(ApplicationPreferences.HIDE_SEARCH_CRITERIAS,
				translationService.translate("@Preferences.Print.HideSearchCriterias", null),
				translationService.translate("@Preferences.Print.HideSearchCriterias.Tooltip", null), 0.6, DisplayType.CHECK, true));
		psd.add(new PreferenceDescriptor(ApplicationPreferences.DISABLE_PREVIEW, translationService.translate("@Preferences.Print.DisablePreview", null),
				translationService.translate("@Preferences.Print.DisablePreview.Tooltip", null), 0.7, DisplayType.CHECK, false));
	...
	private PreferenceTabDescriptor buildConsoleTab(TranslationService translationService) {
		...
		ptd.add(psd);
		psd.add(new PreferenceDescriptor(ApplicationPreferences.MAX_CHARS, translationService.translate("@Preferences.MaxChars", null),
				translationService.translate("@Preferences.MaxChars.Tooltip", null), 0.1, DisplayType.INTEGER, 24000));
