/*******************************************************************************
 * Copyright (c) 2012 - 2016 Joseph Carroll and others. All rights reserved. This program and the accompanying materials are made available under the terms of
 * the Eclipse Public License v1.0 which accompanies this distribution, and is available at http://www.eclipse.org/legal/epl-v10.html Contributors: Joseph
 * Carroll <jdsalingerjr@gmail.com> - initial API and implementation Lars Vogel <Lars.Vogel@gmail.com> - ongoing maintenance
 ******************************************************************************/
...
public class SelectPerspectiveDialog extends Dialog implements ISelectionChangedListener {
	...
	private void createViewer(Composite parent) {
		...
		viewer.setLabelProvider(new DelegatingLabelProviderWithTooltip(ContextInjectionFactory.make(PerspectiveLabelProvider.class, context),
		...
		viewer.addDoubleClickListener(event -> handleDoubleClickEvent());
	}
