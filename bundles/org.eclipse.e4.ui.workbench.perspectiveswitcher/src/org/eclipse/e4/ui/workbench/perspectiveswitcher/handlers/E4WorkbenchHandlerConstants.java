...
public class E4WorkbenchHandlerConstants {
	...
	/**
	 * Id for handler "Save As" for command "Save As" in category "Perspectives" (value is <code>"org.eclipse.e4.ui.perspectives.handlers.saveAs"</code>).
	 */
	public static final String PERSPECTIVES_SAVE_AS = "org.eclipse.e4.ui.perspectives.handlers.saveAs"; //$NON-NLS-1$

	/**
	 * Id for handler "Reset" for command "Reset" in category "Perspectives" (value is <code>"org.eclipse.e4.ui.perspectives.handlers.reset"</code>).
	 */
	public static final String PERSPECTIVES_RESET = "org.eclipse.e4.ui.perspectives.handlers.reset"; //$NON-NLS-1$

	/**
	 * Id for handler "Close" for command "Close" in category "Perspectives" (value is <code>"org.eclipse.e4.ui.perspectives.handlers.close"</code>).
	 */
	public static final String PERSPECTIVES_CLOSE = "org.eclipse.e4.ui.perspectives.handlers.close"; //$NON-NLS-1$

	/**
	 * Id for handler "Show Text" for command "Show Text" in category "Perspectives" (value is <code>"org.eclipse.e4.ui.perspectives.handlers.showText"</code>).
	 */
