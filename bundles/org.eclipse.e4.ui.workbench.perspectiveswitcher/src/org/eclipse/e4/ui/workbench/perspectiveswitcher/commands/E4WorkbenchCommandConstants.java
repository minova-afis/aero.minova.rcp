...
public interface E4WorkbenchCommandConstants {
	...
	/**
	 * Id for command "Show Perspective" in category "Perspectives" (value is <code>"org.eclipse.e4.ui.perspectives.showPerspective"</code>).
	 */
	...
	/**
	 * Description for command "Show Perspective" in category "Perspectives" (value is <code>"Opens a new perspective"</code>).
	 */
	...
	/**
	 * Description for command "Reset" in category "Perspectives" (value is <code>"Resets the perspective to its default state"</code>).
	 */
	...
	/**
	 * Id for command "Show Text" in category "Perspectives" (value is <code>"org.eclipse.e4.ui.perspectives.showText"</code>).
	 */
	...
	/**
	 * Description for command "Show Text" in category "Perspectives" (value is <code>"Displays the perspective name next to its icon"</code>).
	 */
