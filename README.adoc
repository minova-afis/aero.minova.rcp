...
[INFO] 
[INFO] ------------------< name.saak.tycho:eclipse-2019-03 >-------------------
[INFO] Building eclipse-2019-03 1.0.2-SNAPSHOT
[INFO] ---------------------[ eclipse-target-definition ]----------------------
[INFO] 
...
[INFO] Working directory: /Users/saak/git/2020tycho/releng/target-definition
[WARNING] Ignoring unrecognized line: ?? releng/target-definition/release.properties
[INFO] Checking dependencies and plugins for snapshots ...
What is the release version for "eclipse-2019-03"? (name.saak.tycho:eclipse-2019-03) 1.0.2: : 1.1.0 <3>
What is SCM release tag or label for "eclipse-2019-03"? (name.saak.tycho:eclipse-2019-03) eclipse-2019-03-1.1.0: : <4>
What is the new development version for "eclipse-2019-03"? (name.saak.tycho:eclipse-2019-03) 1.1.1-SNAPSHOT: : <5>
...
Sie befindet sich im Ordner `releng/name.saak.tycho.configuration`.

Sie enthält den Verweis auf die Target Platform.

include::releng/name.saak.tycho.configuration/pom.xml[tags=target-definition]
...
name.saak.tycho.configuration-1.0.0
name.saak.tycho.configuration-1.0.1
name.saak.tycho.configuration-1.0.2
name.saak.tycho.configuration-1.0.3
name.saak.tycho.configuration-1.0.4
name.saak.tycho.configuration-1.1.0
name.saak.tycho.configuration-1.2.0
name.saak.tycho.root-1.0.1
name.saak.tycho.root-1.0.2
name.saak.tycho.root-1.0.3
name.saak.tycho.root-1.1.0
name.saak.tycho.root-1.2.0
----

Jedes Release verfügt über ein eigenes Tag.
Das Root-Projekt hat die Tags, die mit `name.saak.tycho.root-` beginnen.
...
$ mvn release:prepare \
  ...
  -Dtag=name.saak.tycho.root-1.3.0 <3>
----
...
Wenn man es mal irgendwo konfiguriert, könnte man auch als Tagnamen den Namen des Produktprojektes (`name.saak.tycho.product`) verwenden.

===== Build abschließen

Sobald die Vorbereitung erfolgreich war, kann man den Build abschließen.
Damit wird er dann auch auf unserem link:http://nexus.minova.com:8081/nexus/#view-repositories;releases~browsestorage~name/saak/tycho/name.saak.tycho.product[Nexus] gespeichert.
