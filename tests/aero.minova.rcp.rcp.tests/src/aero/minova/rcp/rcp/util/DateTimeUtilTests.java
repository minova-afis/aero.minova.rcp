...
public class DateTimeUtilTests {
	...
	public void testGetDateTime_0() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDate89_809() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, SEPTEMBER, 8).atStartOfDay().plusHours(8).plusMinutes(9)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime312_312() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, DECEMBER, 3).atStartOfDay().plusHours(3).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime_312() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(3).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime911_911() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, NOVEMBER, 9).atStartOfDay().plusHours(9).plusMinutes(11)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime_911() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(9).plusMinutes(11)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime1109_0() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, SEPTEMBER, 11).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime1109_Plus() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, SEPTEMBER, 11).atStartOfDay().plusHours(19).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime1109_PlusPlus() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, SEPTEMBER, 11).atStartOfDay().plusHours(20).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		assertEquals(expected, DateTimeUtil.getDateTime(bithday, "1109 ++"));
	}
	...
	public void testGetDateTime1109_PlusPlusPlus() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, SEPTEMBER, 11).atStartOfDay().plusHours(21).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		assertEquals(expected, DateTimeUtil.getDateTime(bithday, "1109 +++"));
	}
	...
	public void testGetDateTime1109_1109() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, SEPTEMBER, 11).atStartOfDay().plusHours(11).plusMinutes(9)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime_1109() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(11).plusMinutes(9)
				.toInstant(ZoneOffset.UTC);
		assertEquals(expected, DateTimeUtil.getDateTime(bithday, " 1109"));
	}
	...
	public void testGetDateTime1109_2() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, SEPTEMBER, 11).atStartOfDay().plusHours(2).plusMinutes(0)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime90412_904() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1912, APRIL, 9).atStartOfDay().plusHours(9).plusMinutes(4)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime_3092002() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(3).plusMinutes(9)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime13121865_153() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1865, DECEMBER, 13).atStartOfDay().plusHours(1).plusMinutes(53)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime13121865_153_3h() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1865, DECEMBER, 13).atStartOfDay().plusHours(4).plusMinutes(53)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTimePlus_Plus() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, MAY, 24).atStartOfDay().plusHours(19).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTimePlusPlus_PlusPlus() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, MAY, 25).atStartOfDay().plusHours(20).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		assertEquals(expected, DateTimeUtil.getDateTime(bithday, "++ ++"));
	}
	...
	public void testGetDateTime1109PlusPlus_PlusPlus() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, SEPTEMBER, 13).atStartOfDay().plusHours(20).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		assertEquals(expected, DateTimeUtil.getDateTime(bithday, "1109++ ++"));
	}
	...
	public void testGetDateTime2Plus3t_PlusPlus() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, MAY, 5).atStartOfDay().plusHours(20).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime2Plus3m_PlusPlus() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(1967, Month.AUGUST, 2).atStartOfDay().plusHours(20).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime1Plus1Wplus1J_6Plus1hPlus1m() {
		Instant bithday = LocalDate.of(2020, MAY, 13).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(2021, MAY, 8).atStartOfDay().plusHours(7).plusMinutes(1)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime01012020PlusPlusPlusM() {
		Instant bithday = LocalDate.of(2020, MAY, 13).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(2020, APRIL, 01).atStartOfDay().plusHours(7).plusMinutes(1)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTime_825PlusPLusPlusM() {
		Instant bithday = LocalDate.of(2020, MAY, 13).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(2020, MAY, 13).atStartOfDay().plusHours(8).plusMinutes(28)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDate02Slash05Slash1988Stern1530() {
		Instant bithday = LocalDate.of(1967, MAY, 23).atStartOfDay().plusHours(18).plusMinutes(12)
				.toInstant(ZoneOffset.UTC);
		Instant expected = LocalDate.of(2088, Month.FEBRUARY, 5).atStartOfDay().plusHours(15).plusMinutes(30)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTimeZoneIDEuropeMonaco() {
		Instant bithday = LocalDate.of(2020, MAY, 13).atStartOfDay().plusHours(18).plusMinutes(12)
				.atZone(ZoneId.of("Europe/Monaco")).toInstant();
		Instant expected = LocalDate.of(2020, MAY, 13).atStartOfDay().plusHours(8).plusMinutes(28)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTimeZoneIDEuropeLondon() {
		...
		Instant expected = LocalDate.of(2020, MAY, 13).atStartOfDay().plusHours(9).plusMinutes(28)
				.toInstant(ZoneOffset.UTC);
	...
	public void testGetDateTimeZoneIDAmericaJuneau() {
		Instant bithday = LocalDate.of(2020, MAY, 13).atStartOfDay().plusHours(18).plusMinutes(12)
				.atZone(ZoneId.of("America/Juneau")).toInstant();
		Instant expected = LocalDate.of(2020, MAY, 13).atStartOfDay().plusHours(18).plusMinutes(28)
				.toInstant(ZoneOffset.UTC);
