...
In Version 12 können mehrere Knöpfe zu einer Gruppe zusammengefasst werden (`group`-Tag in der xml). 
...
Das verwendete Icon muss (wie die andern Bilder der Maske) im ``src/main/app/images/`` Ordner abgelegt werden.
